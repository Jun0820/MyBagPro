...
export const BALL_DATABASE: GolfBall[] = [
  ...
  },
  {
    ...
    type: 'スピン系・ディスタンス',
    img: BALL_IMAGE,
    desc: '2026年モデルのCallawayツアーボール。飛距離、弾道の安定性、ショートゲームスピンのバランスを重視した主力モデル。',
    profiles: {
  ...
  {
    id: 'chrome-tour-td-2026',
    name: 'Chrome Tour Triple Diamond',
    brand: 'Callaway',
    type: '低スピン・強弾道',
    img: BALL_IMAGE,
    desc: '2026年に発表された低スピン寄りのツアーボール。速いスイングで吹け上がりを抑え、前に強い弾道を作りたいプレーヤー向け。',
    profiles: {
  ...
  },
  {
    ...
    type: 'スピン系・ソフトフィーリング',
    img: BALL_IMAGE,
    desc: '2026年TOUR Bシリーズのスピン重視モデル。アプローチの止まり方と柔らかい打感を重視したいゴルファー向け。',
    profiles: {
      targetSpeed: ['40-43', '44-47', '48-49'],
      targetScore: ['under80', '80s', '90s'],
      targetConcern: ['spin', 'feel'],
  ...
  },
  {
    ...
    type: 'ディスタンス系・ツアー',
    img: BALL_IMAGE,
    desc: '2026年TOUR Bシリーズの飛距離重視モデル。ドライバー初速とツアーレベルのグリーン周り性能を両立したい人向け。',
    profiles: {
      targetSpeed: ['44-47', '48-49', 'over50'],
      targetScore: ['under80', '80s', '90s'],
      targetConcern: ['distance', 'stability'],
      targetTrajectory: ['straight', 'draw'],
    },
    radar: { distance: 5, spin: 4.5, feel: 4 },
  },
  {
    id: 'e12-straight-2026',
    name: 'e12 Straight',
    brand: 'Bridgestone',
    type: '直進性・曲がり軽減',
    img: BALL_IMAGE,
