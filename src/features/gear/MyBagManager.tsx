...
const SHAFT_SUGGESTIONS = [
    ...
    'TENSEI', 'TENSEI Pro Blue 1K', 'TENSEI Pro Blue 1K 50', 'TENSEI Pro Blue 1K 60', 'TENSEI Pro White 1K', 'TENSEI Pro White 1K 60', 'TENSEI Pro Orange 1K', 'TENSEI Pro Orange 1K 50', 'TENSEI Pro Black 1K Core', 'TENSEI Pro Black 1K Core 60', 'TENSEI 1K Hybrid',
    'VANQUISH', 'VANQUISH VV', 'VANQUISH VV 4', 'VANQUISH VV 5', 'VANQUISH VV 6', 'VANQUISH Driver', 'VANQUISH FW', 'VANQUISH Hybrid', 'VANQUISH Iron', 'KAI\'LI', 'MMT',
    'LIN-Q', 'LIN-Q BLUE EX', 'LIN-Q BLUE EX 5', 'LIN-Q BLUE EX 6', 'LIN-Q WHITE EX', 'LIN-Q WHITE EX 5', 'LIN-Q WHITE EX 6', 'LIN-Q RED EX', 'LIN-Q RED EX 5', 'LIN-Q RED EX 6', 'LIN-Q PowerCore Blue', 'LIN-Q PowerCore Blue 5', 'LIN-Q PowerCore White', 'LIN-Q PowerCore White 6', 'LIN-Q PowerCore Red', 'LIN-Q PowerCore Hybrid', 'ATTAS', 'ATTAS RX SUNRISE RED', 'ATTAS RX SUNRISE RED 5', 'ATTAS RX SUNRISE RED 6', 'ATTAS MB-FW', 'ATTAS MB-HY', 'Helium', 'Recoil', 'PROFORCE',
    ...
    'MODUS', 'MODUS3 TOUR 105', 'MODUS3 TOUR 105 S', 'MODUS3 TOUR 105 X', 'MODUS3 TOUR 115', 'MODUS3 TOUR 115 S', 'MODUS3 TOUR 120', 'MODUS3 TOUR 120 S', 'MODUS3 TOUR 125', 'MODUS3 TOUR 125 S', 'MODUS3 TOUR 130', 'MODUS3 WEDGE', 'MODUS3 HYBRID',
    'N.S.PRO 950GH neo', 'N.S.PRO 950GH neo S', 'N.S.PRO 950GH neo R', 'N.S.PRO 850GH', 'N.S.PRO 850GH neo', 'N.S.PRO 750GH neo', 'N.S.PRO 750GH neo R', 'Zelos 7', 'Zelos 8', 'Regio Formula', 'Regio Formula MB+', 'Regio Formula B+', 'PING ULT 250D', 'PING ULT 250F', 'PING ULT 250H',
    'KBS TOUR', 'KBS C-TAPER', 'KBS TOUR LITE', 'KBS PGI',
    'MCI', 'MCI 50', 'MCI 60', 'MCI 70', 'MCI 80', 'MCI 90', 'PING TOUR', 'PING TOUR 2.0 CHROME 65', 'PING TOUR 2.0 BLACK 65', 'ALTA J CB', '純正シャフト', 'その他'
];
        ...
        <div className="grid gap-2 md:grid-cols-5">
            {[
                ...
                <button
                    ...
                    className={cn(
                        'min-h-[44px] rounded-lg px-3 py-2 text-left text-xs font-black transition ring-1 disabled:cursor-not-allowed disabled:opacity-60',
                                    ...
                                    <div className="flex min-h-[72px] flex-col gap-3 px-3 py-3 md:flex-row md:items-center md:justify-between">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex min-h-[36px] items-center rounded-lg border border-rose-200 bg-rose-50 px-3 text-xs font-black text-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
                                            >
                                                削除
                                            </button>
                                        </div>
                                    ...
                                    {isExpanded && editorDraft && (
                                        <div className="border-t border-slate-100 p-3">
                                            ...
                                            <div className="mt-4 flex flex-wrap justify-end gap-2">
                                                <button type="button" disabled={isClubEditorSaving} onClick={cancelClubEditor} className="inline-flex min-h-[40px] items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-xs font-black text-slate-600 disabled:cursor-not-allowed disabled:opacity-60">
                                                    キャンセル
                                                </button>
