...
const SHAFT_SUGGESTIONS = [
    ...
    'SPEEDER NX', 'SPEEDER NX BLACK', 'SPEEDER NX BLACK 50', 'SPEEDER NX BLACK 60', 'SPEEDER NX GREEN', 'SPEEDER NX GREEN 50', 'SPEEDER NX GREEN 60', 'SPEEDER NX VIOLET', 'SPEEDER NX VIOLET 50', 'SPEEDER NX VIOLET 60', 'SPEEDER NX GOLD', 'SPEEDER NX GOLD 50', 'SPEEDER NX GOLD 60',
