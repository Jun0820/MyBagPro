...
export const tournamentSpotlights: TournamentSpotlight[] = [
  {
    ...
    summary:
      '河本結がプレーオフを制して今季2勝目。吉澤柚月、神谷そら、政田夢乃らの結果と、確認済みクラブセッティングへの導線を整理しました。',
    featuredPlayerSlugs: ['yui-kawamoto', 'kamiya-sora', 'yumeno-masada', 'sakuma-akari'],
  },
  {
    ...
    eventDates: '2026年5月28日-31日',
    summary:
      'ショーン・ノリスが通算24アンダーで優勝。米澤蓮と永野竜太郎を含む全英切符の3人と、国内男子の番手構成を読みやすく整理しました。',
    featuredPlayerSlugs: ['ren-yonezawa', 'ryutaro-nagano', 'satoshi-kodaira', 'ryosuke-kinoshita'],
  },
  {
    articleSlug: 'shoprite-lpga-2026-result-boutier-setting-review',
    tourKey: 'lpga',
    tourLabel: 'LPGA',
    tournamentName: 'ShopRite LPGA powered by Wakefern',
    statusLabel: '結果更新',
    eventDates: '2026年5月29日-31日',
    summary:
      'セリーヌ・ブティエが最終日66で逆転優勝。全米女子オープン前週の勝ち方と、確認済みクラブセッティングページへの入口をまとめました。',
    featuredPlayerSlugs: ['celine-boutier'],
  },
  {
